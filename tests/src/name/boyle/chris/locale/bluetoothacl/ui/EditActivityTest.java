...
import name.boyle.chris.locale.bluetoothacl.test.BundleTestHelper;
...
public final class EditActivityTest extends ActivityInstrumentationTestCase2<EditActivity>
{
    ...
    {
        super("name.boyle.chris.locale.bluetoothacl", EditActivity.class); //$NON-NLS-1$
    }
    ...
    public void testActivityName()
    {
        ...
        assertEquals("name.boyle.chris.locale.bluetoothacl.ui.EditActivity", EditActivity.class.getName()); //$NON-NLS-1$
    }
    ...
    public void testNewConditionSaveOff()
    {
         ...
         */
        mListView.setItemChecked(EditActivity.getPositionForIdInArray(mTargetContext, R.array.display_states, R.string.list_off), true);
    ...
    public void testEditOldConditionOff()
    {
         ...
         * Verify the initial UI values
         */
        assertEquals(EditActivity.getPositionForIdInArray(mTargetContext, R.array.display_states, R.string.list_off), mListView.getSelectedItemPosition());
